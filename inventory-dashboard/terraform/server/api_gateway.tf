...
resource "aws_api_gateway_rest_api" "main" {
  ...
  description = "Inventory Dashboard API"
...
####################################################################
# Catch-all proxy resource  ({proxy+} covers every sub-path;
# the root resource covers "/")
####################################################################
...
####################################################################
# CORS gateway responses (for auth failures, server errors)
####################################################################
...
resource "aws_api_gateway_deployment" "main" {
  ...
  # Redeploy whenever any method/integration changes
  triggers = {
...
resource "aws_api_gateway_stage" "main" {
  ...
  # access_log_settings requires an account-level CloudWatch Logs role ARN to
  # be configured via aws_api_gateway_account first. Omitted here; enable via
  # the Spacelift stack once the account-level role is in place.
